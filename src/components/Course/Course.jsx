...
const Course = ({course, handleCourses}) => {
  ...
  return(
    <>
      <div className='flex flex-col gap-3 justify-between bg-white p-4 rounded-sm hover:shadow-2x1 transition-[position,box-shadow] relative hover:-top-2'>
       <div className='w-full max-h-40 lg:max-h-[160px]'>
